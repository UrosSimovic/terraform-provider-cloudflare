...
func dataSourceCloudflareUserTokenPermissionGroups() *schema.Resource {
	return &schema.Resource{
		Read:dataSourceCloudflareUserTokenPermissionGroupsRead,
...
func dataSourceCloudflareUserTokenPermissionGroupsRead(d *schema.ResourceData, meta interface{}) error {
	log.Printf("[DEBUG] Reading User Token Permission Groups")
	client := meta.(*cloudflare.API)

	permissions, err := client.UserTokensPermissionGroups()
	if err != nil {
